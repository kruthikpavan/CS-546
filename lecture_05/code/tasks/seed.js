...
const main = async () => {
	...
	const firstPost = await posts.addPost('Hello, class!      ', 'Today we are creating a blog!          ', pid);
	...
	const third = await posts.addPost('Using routes', 'The purpose of today is to simply look at some GET routes', aid);
